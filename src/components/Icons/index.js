...
export const SearchIcon = (props) => (
  <Icon {...props}>
    <path
      ...
      fill={props.color ? props.color : '#DCD8D8'}
    />
    <path
      ...
      fill={props.color ? props.color : '#F0F0F0'}
    />
    <circle cx="9.33333" cy="6.66667" r="0.666667" fill={props.color ? props.color : '#F0F0F0'} />
  </Icon>
)

export const CardStatisticsIcon = (props) => (
  <Icon {...props}>
    <path
      fill="#fff"
      fillOpacity="0.653"
...
export const HomeIcon = (props) => (
  <Icon position='relative' {...props}>
    <path fill='currentColor' fillRule="evenodd" clipRule="evenodd" d="M1 6.22222L9 0L17 6.22222V16C17 16.9818 16.2041 17.7778 15.2222 17.7778H2.77778C1.79594 17.7778 1 16.9818 1 16V6.22222Z" stroke={props.stroke ? props.stroke : "#54565a"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    <path fill='currentColor' d="M6.33333 17.7778V8.88892H11.6667V17.7778" stroke={props.stroke ? props.stroke : "#54565a"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </Icon>
)
...
export const LibraryIcon = (props) => (
  <Icon position='relative' {...props}>
    <path
      ...
      stroke={props.stroke ? props.stroke : "#54565a"}
      strokeWidth="2"
      strokeLinecap="round"
...
export const CurrentlyReadingIcon = (props) => (
  <Icon {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
