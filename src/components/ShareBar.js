...
const ShareBarContent = styled.div`
    position: fixed;
    width: calc(100% - 40px);
    height: 56px;
    left: 20px;
    bottom: 50px;
    background: #FFFFFF;
    box-shadow: 3px 3px 23px rgb(107 103 70 / 13%);
    border-radius: 2px;
    display: flex;
...
export const ShareBar = () => {
    return (
        <ShareBarContent>
            <ShareBarItem>
                <svg width="17" height="16" viewBox="0 0 17 16" style={{ "marginRight": '5px' }} fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 0H4.8C6.56731 0 8 1.59188 8 3.55556V16C8 14.5272 6.92548 13.3333 5.6 13.3333H0V0Z" stroke="#CFCBD2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M16 0H11.2C9.43269 0 8 1.59188 8 3.55556V16C8 14.5272 9.07452 13.3333 10.4 13.3333H16V0Z" stroke="#CFCBD2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                Read
            </ShareBarItem>
            <ShareBarItem style={{ "borderLeft": "1px solid rgba(151, 151, 151, 0.2)", "borderRight": "1px solid rgba(151, 151, 151, 0.2)", "padding": "5px 35px" }}>
                <svg width="18" height="16" viewBox="0 0 18 16" style={{ "marginRight": '5px' }} fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 13.3333V8C6.58375e-08 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8V13.3333" stroke="#CFCBD2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <ShareBarItem>
                <svg width="14" height="16" viewBox="0 0 14 16" style={{ "marginRight": '5px' }} fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 8V14.4C0 15.2837 0.716344 16 1.6 16H11.2C12.0837 16 12.8 15.2837 12.8 14.4V8" stroke="#CFCBD2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M9.60001 3.2L6.40001 0L3.20001 3.2" stroke="#CFCBD2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M6.40002 0V10.4" stroke="#CFCBD2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                Share
            </ShareBarItem>
        </ShareBarContent>
